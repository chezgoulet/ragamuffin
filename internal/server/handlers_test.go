...
func newTestServer() *Server {
	...
	return New(cfg, nil, nil, nil, nil, idxm, nil, rl, nil, nil, nil, nil, nil, slog.Default(), nil)
}
...
func TestHandleAsk_MissingQuery(t *testing.T) {
	...
	idxm := indexer.NewManager()
	idxm.Add("default", indexer.New("/test/vault", nil, nil, nil), nil)
	srv := New(cfg, nil, nil, nil, nil, idxm, nil, rl, nil, nil, nil, nil, nil, slog.Default(), nil)
