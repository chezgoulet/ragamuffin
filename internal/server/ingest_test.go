...
func TestHandleIngest_SingleTenantDefaultsToDefault(t *testing.T) {
	...
	srv := New(cfg, nil, nil, nil, nil, idxManager, nil, rl, nil, nil, nil, nil, nil, slog.Default(), nil)
...
func TestHandleIngest_ProvisionInvalidName(t *testing.T) {
	...
	rl := ratelimit.New(false)
	srv := New(cfg, nil, nil, nil, nil, indexer.NewManager(), nil, rl, nil, nil, nil, nil, nil, slog.Default(), nil)
...
func TestProvisionVault_InvalidName(t *testing.T) {
	srv := New(&config.Config{}, nil, nil, nil, nil, indexer.NewManager(), nil, ratelimit.New(false), nil, nil, nil, nil, nil, slog.Default(), nil)
...
func TestProvisionVault_NoQdrant_ReturnsNil(t *testing.T) {
	...
	srv := New(cfg, nil, nil, nil, nil, indexer.NewManager(), nil, ratelimit.New(false), nil, nil, nil, nil, nil, slog.Default(), nil)
